...
def user_sessions(request):
    """Handle user session creation/update via Firebase token authentication.
    
    Validates Firebase token, creates or updates user record, and stores user info in Django session.
    """
